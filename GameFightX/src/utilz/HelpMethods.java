...
public class HelpMethods {
    ...
    public static boolean IsSigntClear(int[][] lvlData, Rectangle2D.Float firstHitbox,
...
//                System.out.print(lvlData[j][i] + "\t"); // \t để tạo khoảng cách giữa các số
//            }
...
//        }
    ...
    public static ArrayList<Crabby> GetCrab(BufferedImage img){
