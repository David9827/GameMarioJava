...
public class PauseOverlay {
    ...
    private void createVolumeButton() {
        ...
        volumeButton = new VolumeButton(vX, vY, SIDER_WIDTH, VOLUME_HEIGHT);
    }
    ...
    public void mouseReleased(MouseEvent e) {
        ...
        replayB.reserBools();
        unpauseB.reserBools();
        volumeButton.reserBools();
    }

    public void mouseMoved(MouseEvent e) {
        musicButton.setMouseMover(false);
        sfxButton.setMouseMover(false);
        ...
        if (isIn(e, musicButton))
            musicButton.setMouseMover(true);
        else if (isIn(e, sfxButton))
            sfxButton.setMouseMover(true);
        else if (isIn(e, menuB))
